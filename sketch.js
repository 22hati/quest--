...
function setup() {
    ...
    //coins
    coin = createSprite(displayWidth-170,displayHeight-110);
    coin.addImage(coinImg);
    coin.scale = 0.3;

    coin2 = createSprite(displayWidth-570,displayHeight-110);
...
function draw() {
    ...
    coin.velocityX = player.velocityX*-1;
    coin2.velocityX = player.velocityX*-1;
    ...
    fill("white");
    textSize(30);
    text("coins : "+coins,20,30);
    coinSense(coin);
    coinSense(coin2);
}
function coinSense(c) {
